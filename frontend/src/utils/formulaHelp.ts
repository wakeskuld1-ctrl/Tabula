...
// - 2026-03-15 00:20: 原因=国际化要求; 目的=覆盖双语字段过滤
...
export type FormulaHelpItem = {
  ...
  example: string;
  // ### 变更记录
  // - 2026-03-15 00:20: 原因=参数别名用于业务化理解; 目的=双语提示
  paramNotes: string;
  // ### 变更记录
...
// ### 变更记录
// - 2026-03-15 00:20: 原因=过滤逻辑需要统一入口; 目的=供UI与测试复用
// - 2026-03-15 00:20: 原因=避免重复实现搜索; 目的=集中处理大小写与空值
export function filterFormulaHelpItems(items: FormulaHelpItem[], query: string) {
  ...
  // ### 变更记录
  // - 2026-03-15 00:20: 原因=多字段匹配; 目的=覆盖函数名/用途/参数说明
